...
int main(int argc, char *argv[]) {
    ...
    triangle.push_back(ecg::vec4(300, 100, 0, 1));
    triangle.push_back(ecg::vec4(600, 400, 0, 1));
    triangle.push_back(ecg::vec4(100, 400, 0, 1));

    //Define colors for each of the triangle vertices
    std::vector<ecg::vec4> triangleColors;
    triangleColors.push_back(ecg::vec4(255, 0, 0, 255));
    triangleColors.push_back(ecg::vec4(0, 255, 0, 255));
    triangleColors.push_back(ecg::vec4(0, 0, 255, 255));
