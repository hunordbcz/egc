...
namespace ecg {
    ...
    int testMat3Implementation() {
        ...
        ecg::vec3 v1(1.0f, 1.0f, 1.0f);
        ecg::vec3 v2(4.0f, 4.0f, 1.0f);
        ecg::vec3 v3;
    ...
    int testMat4Implementation() {
        ...
        ecg::vec4 v1(1.0f, 1.0f, 1.0f, 1.0f);
        ecg::vec4 v2(4.0f, 4.0f, 4.0f, 1.0f);
        ecg::vec4 v3;
